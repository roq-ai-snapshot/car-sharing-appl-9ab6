  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the freedom of mobility with Car Sharing Application, your ultimate solution for hassle-free and economical commuting."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the freedom of mobility with Car Sharing Application, your ultimate solution for hassle-free and economical commuting.`}
            </Text>
            <Box
